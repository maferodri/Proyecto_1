...
# URI de prueba — usa variables de entorno o .env idealmente
URI = os.getenv("URI")
COLL = get_collection(URI, db="demo_db", col="bank_test")  # mejor usar una colección separada para pruebas
